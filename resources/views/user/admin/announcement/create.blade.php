<x-dashboard.admin.base>
    ...
    <x-dashboard.page-label title="Announcement Create" :back_url="route('admin.announcements.index')" />

    <div class="panel p-2 flex flex-col gap-2">

        <form action="{{ route('admin.announcements.store') }}" method="post" class="flex flex-col gap-2 w-full h-full">
            @csrf
